...
** Packages
*** Importer
#+begin_src nix-ts :tangle modules/packages/default.nix
{ ... }:
...
*** Emacs
**** Importer
#+begin_src nix-ts :tangle modules/packages/emacs/default.nix
{ ... }:
...
*** Scripts
**** Importer
#+begin_src nix-ts :tangle modules/packages/scripts/default.nix
{ ... }:
...
** shells
*** boilerplate
#+begin_src nix-ts :tangle modules/shells.nix :noweb yes
{
...
***** Premble
#+begin_src nix-ts :tangle modules/dash.nix :noweb yes 
{

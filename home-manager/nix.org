...
Languages we would like to support:
+ [ ] xml
Non-language activities:
+ [ ] Separate html & css support

**** Default.nix
#+begin_src nix :tangle development/default.nix
  { pkgs, lib, ... }:
...
**** Treesitter
#+begin_src nix :tangle development/treesitter.nix
  { pkgs, lib, config, ... } :
...
**** Hy
#+begin_src nix :tangle development/hy.nix
  { pkgs, lib, config, ... }:
...
**** Gradle
#+begin_src nix :tangle development/gradle.nix
  { pkgs, config, lib, ... } :
...
**** Kotlin
#+begin_src nix :tangle development/kotlin.nix
  { pkgs, config, lib, ... }:
  # This module is blatantly stolen from doom emacs
...
**** Html
#+begin_src nix :tangle development/html.nix
  { pkgs, config, lib, ... }:
...
**** css
#+begin_src nix :tangle development/css.nix
  { pkgs, config, lib, ... }:
...
**** Javascript
#+begin_src nix :tangle development/javascript.nix
  { pkgs, config, lib, ... }:
...
**** Typescript
#+begin_src nix :tangle development/typescript.nix
  { pkgs, config, lib, ... }:
...
**** Pug
#+begin_src nix :tangle development/pug.nix
  { pkgs, config, lib, ... }:
...
**** Zenscript
#+begin_src nix :tangle development/zenscript.nix
  { pkgs, config, lib, ... }:
...
**** Fennel
#+begin_src nix :tangle development/fennel.nix
  { pkgs, config, lib, ... }:
...
**** Plantuml
#+begin_src nix :tangle development/plantuml.nix
  { pkgs, config, lib, ... }:
...
**** Go
#+begin_src nix :tangle development/go.nix
  { pkgs, lib, config, ... }:
...
**** Markdown
#+begin_src nix :tangle development/markdown.nix
  { pkgs, lib, config, ... }:
...
**** Zig
#+begin_src nix :tangle development/zig.nix
  { pkgs, lib, config, ... }:
...
**** LaTeX
#+begin_src nix :tangle development/latex.nix
   { pkgs, config, lib, ... } :
...
**** C Sharp
#+begin_src nix :tangle development/csharp.nix
  { pkgs, lib, config, ... }:
...
**** Ruby
#+begin_src nix :tangle development/ruby.nix
  { pkgs, lib, config, ... }:
...
**** Common Lisp
#+begin_src nix :tangle development/common-lisp.nix
  { pkgs, lib, config, ... }:
...
**** Scheme
#+begin_src nix :tangle development/scheme.nix
  { pkgs, lib, config, ... }:
...
**** Xml
#+begin_src nix :tangle development/xml.nix
  { pkgs, config, lib, ... }:

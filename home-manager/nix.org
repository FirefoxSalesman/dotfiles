...
*** modules
#+begin_src nix-ts :tangle term/default.nix
{ ... }:
...
**** Eat
#+begin_src nix-ts :tangle term/eat.nix
{ lib, config, ... }:
...
**** Eshell
#+begin_src nix-ts :tangle term/eshell.nix
{ pkgs, config, lib, ... }:
...
**** Term
#+begin_src nix-ts :tangle term/term.nix
{ config, lib, ... }:
...
**** Coterm
#+begin_src nix-ts :tangle term/coterm.nix
{ config, lib, ... }:
...
**** Vterm
#+begin_src nix-ts :tangle term/vterm.nix
{ config, lib, ... }:

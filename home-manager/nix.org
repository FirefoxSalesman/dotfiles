...
#+begin_src nix-ts :tangle modules/packages/scripts/updatefix.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle modules/packages/scripts/pkg.nix
{ inputs, ... }:
{
...
** glx
#+NAME: glx
#+begin_src nix-ts :tangle modules/glx.nix
{ inputs, ... }:
{
  flake = {

...
**** Default.nix
#+begin_src nix :tangle lsp-support/default.nix
  { lib, ... }:
...
**** Eglot
#+begin_src nix :tangle lsp-support/eglot.nix
  { pkgs, config, lib, ... }:
...
**** lsp mode
#+begin_src nix :tangle lsp-support/lsp-mode.nix
  { pkgs, config, lib, ... }:
...
**** lsp bridge
#+begin_src nix :tangle lsp-support/lsp-bridge.nix
  { pkgs, config, lib, ... }:
...
**** Purescript
#+begin_src nix :tangle language-support/purescript.nix
  { pkgs, config, lib, ... }:

...
** Emacs
*** Dired Single
#+begin_src nix-ts :tangle modules/packages/emacs/dired-single.nix
{ inputs, ... } :
...
*** App Launcher
#+begin_src nix-ts :tangle modules/packages/emacs/app-launcher.nix
{ inputs, ... } :
...
*** Ezf
#+begin_src nix-ts :tangle modules/packages/emacs/ezf.nix
{ inputs, ... } :
...
#+begin_src nix-ts :tangle modules/packages/emacs/embark.nix
{ inputs, ... }:
...
** Scripts
*** mpvmacs
Play a file with mpv, controllable by emacs
#+begin_src nix-ts :tangle modules/packages/scripts/mpvmacs.nix
{ inputs, ... }:
...
*** Doomer
#+begin_src nix-ts :tangle modules/packages/scripts/doomer.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle modules/packages/scripts/ezf.nix
{ inputs, ... }:
...
#+end_src
*** Udisksmenu
#+begin_src nix-ts :tangle modules/packages/scripts/udisksmenu.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle modules/packages/scripts/wiki.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle modules/emacs/completion-system.nix :noweb yes 
{ inputs, ... }:

...
#+begin_src nix-ts :tangle modules/window-manager/tab-bar.nix
{
...
*** Golden Ratio
#+begin_src nix-ts :tangle modules/window-manager/golden-ratio.nix
{

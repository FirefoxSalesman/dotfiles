...
** Emacs
*** Doom Nano Modeline
#+begin_src nix-ts :tangle modules/packages/emacs/doom-nano-modeline.nix
{ inputs, ... }:
...
#+end_src
*** i3status-rust
#+begin_src nix-ts :tangle modules/packages/scripts/i3status-rust.nix
{ inputs, ... }:
...
** Aesthetics
*** Inputs
#+begin_src nix-ts :tangle modules/aesthetics.nix :noweb yes 
{ inputs, ... }:
...
*** Mustache File
#+begin_src json-ts :tangle modules/pywal.json.mustache
{
  "special": {

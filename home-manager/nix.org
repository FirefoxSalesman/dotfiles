...
#+NAME: Aesthetics Discord
#+begin_src nix :noweb yes
  home.file.".config/wal/templates/colours-discord.css".text = ''
    <<Aesthetics Discord File>>
  '';
#+end_src

#+NAME: Aesthetics Discord File
#+begin_src css
  /**
...
https://legacy.curseforge.com/minecraft/mc-mods/search?search=tetra

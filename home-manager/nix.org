...
**** Modules
#+begin_src nix-ts :tangle writing/default.nix
{ ... }:
...
***** Nov
#+begin_src nix-ts :tangle writing/nov.nix
{ pkgs, config, lib, ... }:
...
***** PDF
#+begin_src nix-ts :tangle writing/pdf.nix
{ pkgs, config, lib, ... }:
...
***** Novelist
#+begin_src nix-ts :tangle writing/novelist.nix
{ config, lib, ... }:

...
** Packages
*** Importer
#+begin_src nix-ts :tangle packages/default.nix
{ ... }:
...
*** Overlay
#+begin_src nix-ts :tangle packages/overlay.nix
{ inputs, self, ... }:
...
*** Emacs
**** Importer
#+begin_src nix-ts :tangle packages/emacs/default.nix
{ ... }:
...
**** Semel
#+begin_src nix-ts :tangle packages/emacs/semel.nix
{ inputs, ... } :
...
#+begin_src nix-ts :tangle packages/emacs/reka.nix
{
  lib,
  rustPlatform,
  fetchFromCodeberg,
...
#+begin_src nix-ts :tangle packages/emacs/embark.nix
{ inputs, ... }:
...
*** Scripts
**** Importer
#+begin_src nix-ts :tangle packages/scripts/default.nix
{ ... }:
...
#+begin_src nix-ts :tangle packages/scripts/cast.nix
{ inputs, ... }:
{
...
#+begin_src nix-ts :tangle packages/scripts/mpvmacs.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle packages/scripts/updatefix.nix
{ inputs, ... }:
...
**** Doomer
#+begin_src nix-ts :tangle packages/scripts/doomer.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle packages/scripts/ezf.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle packages/scripts/ffmpeg-bulk.nix
{ inputs, ... }:
...
**** HDMI Helper
#+begin_src nix-ts :tangle packages/scripts/hdmi-helper.nix
{ inputs, ... }:
...
**** Masstube
#+begin_src nix-ts :tangle packages/scripts/masstube.nix
{ inputs, ... }:
...
**** Start-ollama
#+begin_src nix-ts :tangle packages/scripts/start-ollama.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle packages/scripts/pkg.nix
{ inputs, ... }:
{
  perSystem = { pkgs, self', ... }: {
...
#+end_src
**** i3status-rust
#+begin_src nix-ts :tangle packages/scripts/i3status-rust.nix
{ inputs, ... }:
...
#+end_src
**** Udisksmenu
#+begin_src nix-ts :tangle packages/scripts/udisksmenu.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle packages/scripts/wiki.nix
{ inputs, ... }:
...
#+begin_src nix-ts :noweb yes :tangle file-management.nix
{ inputs, ... }:
{
...
#+begin_src nix-ts :noweb yes :tangle emacs/help-system.nix
{
  flake.homeModules.emacs = { ... }:
...
** Password Management
#+begin_src nix-ts :noweb yes :tangle passwords.nix
{
...
#+end_src
** Window Management
#+begin_src nix-ts :noweb yes :tangle window-manager.nix
{
...
#+begin_src nix-ts :tangle keyboard.nix :noweb yes
{

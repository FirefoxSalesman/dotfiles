...
*** GPT.el quick
#+begin_src nix-ts :tangle modules/packages/emacs/gptel-quick.nix
{ inputs, ... }:
...
*** MPC Wrapper
#+begin_src nix-ts :tangle modules/packages/emacs/mpc-wrapper.nix
{ inputs, ... } :
...
*** Qutebrowser
#+begin_src nix-ts :tangle modules/packages/emacs/qutebrowser.nix
{ inputs, ... } :
...
#+begin_src nix-ts :tangle modules/packages/scripts/cast.nix
{ inputs, ... }:
{
...
#+begin_src nix-ts :tangle modules/packages/scripts/ffmpeg-bulk.nix
{ inputs, ... }:
...
*** Masstube
#+begin_src nix-ts :tangle modules/packages/scripts/masstube.nix
{ inputs, ... }:
...
*** Start-ollama
#+begin_src nix-ts :tangle modules/packages/scripts/start-ollama.nix
{ inputs, ... }:
...
#+begin_src nix-ts :tangle modules/multimedia.nix :noweb yes
{ inputs, ... }:
...
** Internet
#+begin_src nix-ts :tangle modules/internet.nix :noweb yes
...
programs.qutebrowser = {
  ...
  settings = {
    ...
    <<Internet Qutebrowser Aesthetics>>
...
#+NAME: Internet Qutebrowser Aesthetics
#+begin_src nix-ts

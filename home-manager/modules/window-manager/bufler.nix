        ...
        bufler = {
          ...
          custom.bufler-groups = ''
            (bufler-defgroups
             ...
             (group (group-or "Notes" (dir "~/doc/denote/")))
             (group
              (group-or
               "AV"
             ...
             (group
              ...
              (group-and
               ...
               (name-match
                ...
                (rx
                 bos "*"
                 (or "Messages" "Warnings" "scratch" "Backtrace" "Pinentry") "*"))
               (lambda (buffer)
          ...
          config = ''
            (general-advice-add
             'bufler-workspace-bookmark-handler
             :after 'pertab--after-switch-to-tab)
            (general-advice-add

{
  flake.homeModules.emacs.programs.emacs.init.usePackage.evil-mc = {
    enable = true;
    defer = true;
    command = [
    ...
    gfhookf = [
      ''
        ('doom-escape (lambda () (when (and (featurep 'evil-mc) (evil-mc-has-cursors-p))
    ...
    generalOne = {
      ...
      global-leader."C" =
        "`,(cmd! (if (eq evil-state 'visual) (evil-mc-make-cursor-in-visual-selection-beg) (evil-mc-hydra/body)))";
    };
    config = ''
      (global-evil-mc-mode)

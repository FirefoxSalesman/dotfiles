{
  flake.homeModules.development.programs.emacs.init = {
    ide.languages.nix.enable = true;
    # Yoinked from heks-emacs
    completions.tempel.templates.nix-ts-mode = {
      ...
      gitpackage = ''
        "{ lib" n ", stdenv" n ", fetchFromGitHub" n ", " (p "inputs") n ", " (p "inputs") n "}:" n n>
